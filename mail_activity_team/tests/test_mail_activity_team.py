...
class TestMailActivityTeam(TransactionCase):
    ...
    def test_activity_count(self):
        ...
        # act2 is team activity on partner_client (today) → 1 record
        ...
        # act2 on partner_client + new activity on employee.partner → 2 records
        ...
        # Base: act1+act2 on partner_client (user=employee) → 1 record with today
        self.assertEqual(res[0]["total_count"], 1)
